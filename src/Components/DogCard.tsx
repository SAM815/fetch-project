...
const DogCard = ({ dog, onClick  }: Props) => {
  ...
  return (
    ...
    className=" bg-[#300D38] rounded-[20px] shadow-md text-white flex flex-col h-[300px] w-full max-w-[200px] mx-auto">
      ...
      <div className="h-[20%] px-3 pb-3 flex items-center mt-3">
        <button
